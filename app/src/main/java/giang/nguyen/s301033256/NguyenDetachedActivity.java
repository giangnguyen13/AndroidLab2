...
public class NguyenDetachedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = findViewById(R.id.giangDetachedLinearLayout);
        ...
        paymentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NguyenDetachedActivity.this, NguyenCheckoutActivity.class);
